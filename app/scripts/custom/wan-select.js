(function() {
  ...
  function WanSelect() {
    ...
    var template = ['<div class="wan-select" outside-click="vm.hideSelect()">',
      ...
      '  <md-button class="md-raised md-primary" ng-click="vm.showSelect()">{{vm.result}}</md-button>',
      ...
      '      <md-button class="md-raised ws-select-button" ng-click="vm.selectNone()">UnSelect All</md-button>',
      '      <md-button class="md-raised ws-select-button" ng-click="vm.selectToggle()">Toggle</md-button>',
      ...
      '        Clear',
      '      </md-button>',
      '      <input ng-model="vm.searchStr" class="ws-search-input" placeholder="Search for">',
      '    </md-input-container>',
      '    <div layout="row" layout-wrap class="ws-selected">',
      '      <span ng-show="selectedData.length === 0" class="ws-none-select">No items Selected</span>',
      ...
      '      <span ng-show="vm.dataUnselected.length === 0" class="ws-none-select">There are no items to choose from</span>',
